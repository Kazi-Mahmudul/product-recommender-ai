...
filesToCheck.forEach((filePath) => {
  ...
  if (usesApiBase) {
    ...
    const hasHttpsEnforcement = content.includes(
      "replace('http://', 'https://')"
    );
...
if (issuesFound === 0) {
  ...
  console.log(
    "3. Add debug logging to see what environment variables are loaded"
  );
...
console.log("");
console.log(
  "⚠️  Make sure these are set in Vercel Dashboard → Project → Settings → Environment Variables"
);

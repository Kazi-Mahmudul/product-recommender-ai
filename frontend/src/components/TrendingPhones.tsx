...
const TrendingPhones: React.FC<TrendingPhonesProps> = ({ darkMode }) => {
  ...
  if (loading) {
    return (
      <section className="w-full max-w-6xl mx-auto px-2 md:px-8 py-2 md:py-8">
            ...
            <div key={phone.id} className="px-1 py-2">
              ...
              >
                ...
                <div className="relative">
                  ...
                  <div className="relative h-24 md:h-48 bg-gradient-to-b from-neutral-50 to-neutral-100 dark:from-neutral-800 dark:to-neutral-900 flex items-center justify-center p-1 md:p-4">
                    <img
                      src={phone.img_url || "/no-image-placeholder.svg"}
                      alt={phone.name}
                      className="h-20 md:h-40 object-contain transition-transform duration-500 group-hover:scale-105"
                      onError={(e) => {
                    ...
                    <div className="absolute top-1 md:top-4 right-1 md:right-4">
                      <span className="inline-flex items-center px-1.5 md:px-2.5 py-0.5 md:py-1 bg-brand/10 text-brand text-[8px] md:text-xs font-medium rounded-full">
                        New
                      </span>
                    </div>
                  </div>

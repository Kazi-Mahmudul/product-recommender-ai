  ...
  return (
    <div className="sticky top-16 z-40 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 py-4">
        <div className="flex items-center gap-3 sm:gap-4 overflow-x-auto scrollbar-hide touch-pan-x">
          {/* Phone Cards */}
            ...
            return (
              ...
              >
                ...
                <div className="relative mb-3">
                  ...
                  {primaryBadge && (
                    <div className="absolute -top-2 left-1/2 transform -translate-x-1/2">
                      <span
                        className={`
                          inline-block text-xs px-2 py-1 rounded-full shadow-sm font-medium
                ...
                <div className="text-center mb-3">
                  ...
                  <h3 className="font-semibold text-sm text-gray-900 dark:text-white line-clamp-2 h-8">
                    {phone.name}
                  </h3>

...
import { getComparisonHistory, clearComparisonHistory, ComparisonHistoryItem as ExportComparisonHistoryItem } from '../../utils/exportUtils';
...
const ComparisonHistory: React.FC<ComparisonHistoryProps> = ({
  ...
  const handleClearHistory = () => {
    if (window.confirm('Are you sure you want to clear all comparison history?')) {
            ...
            {history.length === 0 ? (
              <div className="text-center py-8">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Your comparison history will appear here when you export, share, or save comparisons.
                </p>
              </div>
            ) : (
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <div className="flex items-center text-sm text-gray-500 dark:text-gray-400 mt-1">
                          ...
                          {item.phoneSlugs.length} phone{item.phoneSlugs.length > 1 ? 's' : ''}
                        </div>
                      </div>
                      <div className="ml-4">
          ...
          {history.length > 0 && (
            <div className="px-6 py-4 bg-gray-50 dark:bg-gray-700 border-t border-gray-200 dark:border-gray-600">
              <p className="text-xs text-gray-500 dark:text-gray-400 text-center">
                History is stored locally on your device. Up to 10 recent comparisons are kept.
              </p>
            </div>
          )}
        </div>

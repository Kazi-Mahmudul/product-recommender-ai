...
import { getComparisonHistory, clearComparisonHistory, ComparisonHistoryItem } from '../../utils/exportUtils';
...
const ComparisonHistory: React.FC<ComparisonHistoryProps> = ({
  ...
  const handleHistoryItemClick = (item: ComparisonHistoryItem) => {
    navigate(`/compare/${item.phoneIds.join('-')}`);
    onClose();
  };
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <div className="flex items-center text-sm text-gray-500 dark:text-gray-400 mt-1">
                          ...
                          {item.phoneIds.length} phone{item.phoneIds.length > 1 ? 's' : ''}
                        </div>
                      </div>
                      <div className="ml-4">

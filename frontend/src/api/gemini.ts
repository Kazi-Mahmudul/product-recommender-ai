...
export async function fetchGeminiProsCons(phone: any): Promise<{ pros: string[]; cons: string[] }> {
  ...
  // Enhanced prompt with better context and structure for more detailed analysis
...
4. Be specific about technical advantages with context (e.g., "50MP camera with OIS delivers sharp photos even in challenging lighting")

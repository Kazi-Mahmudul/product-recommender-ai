...
class KnowledgeRetrievalService:
    ...
    def _generate_comparison_structure(self, phone_dicts: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        # Prepare phone info with full details
        phones = []
        for phone in phone_dicts:
            phones.append({
                ...
                "slug": phone.get("slug"),
                "price": phone.get("price_original") or phone.get("price"),
                "url": phone.get("url"),
                ...
                "refresh_rate_numeric": phone.get("refresh_rate_numeric"),
                "ppi_numeric": phone.get("ppi_numeric"),
                ...
                "relevance_score": phone.get("relevance_score", 0.9),
                "match_reasons": phone.get("match_reasons", [])
            })
        ...
        features = [
            ...
            },
            {
                ...
                "label": "Selfie Camera",
                "values": [p.get("selfie_camera_mp") for p in phone_dicts],
                "unit": "MP"
            },
            {
